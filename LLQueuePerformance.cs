...
public class LLQueuePerformance
{
...
/*
 The operations created in the LLQueue class are: Enqueue, Dequeue, and Peek, which operate in O(1) time,
 and Contains in O(n) because it has to traverse the entire list to find the value.
 I didn't detect any performance issues with the queue implementation; performance is good,
 and no memory issues were detected.
*/